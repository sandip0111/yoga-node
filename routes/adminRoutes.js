...
router.post(
  "/sendMailToFreeWebinarForcefully",
  adminController.sendMailToFreeWebinarForcefully,
);
router.post(
...
router.post(
  ...
  paymentController.checkoutPaypalForLiveClasses,
);
router.post(
  "/getPaypalPaymentResultLiveClasses",
  paymentController.getPaypalPaymentResultLiveClasses,
);
router.post(
...
router.post(
  "/checkoutPaypalForPg",
  paymentController.checkoutPaypalForPg,
);
router.post(
...
router.post(
  ...
  paymentController.checkoutPaypalForSwaraSadhana,
);
router.post(
